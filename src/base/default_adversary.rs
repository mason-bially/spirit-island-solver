...
pub fn invader_deck_setup_standard(game: &mut GameState)
{
    ...
    game.log(format!("Removing {{{}}}", game.invader.draw.get(phase3).unwrap()));
    ...
    game.log(format!("Removing {{{}}}", game.invader.draw.get(phase2).unwrap()));
    ...
    game.log(format!("Removing {{{}}}", game.invader.draw.get(phase1).unwrap()));
